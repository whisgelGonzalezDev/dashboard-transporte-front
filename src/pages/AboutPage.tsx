...
export function AboutPage() {
  ...
  useSeo({
    title: `Sobre nosotros · ${config?.nombreNegocio ?? 'Corazón Aventurero'}`,
  ...
  return (
    <PublicLayout>
      <section className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="font-display text-3xl font-bold text-navy-900 dark:text-ivory">Sobre nosotros</h1>
        ...
        {config && (
          <p className="mt-6 whitespace-pre-line text-navy-600 dark:text-navy-300">
            {config.sobreNosotros || 'Aún no se ha configurado esta sección.'}
          </p>
        )}
      </section>
    </PublicLayout>
