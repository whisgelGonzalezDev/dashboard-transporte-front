    ...
    <Modal open title={reserva ? '¡Reserva confirmada!' : `Reservar: ${tour.titulo}`} onClose={onClose}>
      ...
      {reserva && (
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-xl bg-jungle-50 p-4 text-sm text-jungle-800">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-ink-700">Pasajeros del grupo</span>
              <Button
                type="button"
                variant="secondary"
                onClick={addPasajero}
          ...
          <div className="flex justify-between rounded-xl bg-adventure-50 p-3 text-sm text-adventure-800">
